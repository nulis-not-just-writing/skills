...
| Tinjauan sistematis | **slr-cowork** | apakah angkanya dapat direkonsiliasi dan metodenya dapat dipertahankan? |
...
terlampaui. Tiga hal itu tidak diperiksa dua skill sebelumnya.

**`submit` berhenti di temuan fatal.** Ia gerbang bertahap, bukan sapuan menyeluruh. Percuma
memoles tanda hubung pada naskah yang scope-nya meleset — satu temuan fatal membuat sisanya tidak
relevan.

**Revisi bisa memantul balik ke `nulis`.** Bila reviewer menuntut research question atau klaim
kontribusi berubah, itu pekerjaan struktur — kembali ke `nulis` sebelum surat tanggapan ditulis.

## Bila hanya satu yang terpasang
