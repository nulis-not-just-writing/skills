...
*[Read this in English](../slr-cowork.md)*

**v1.5.0** · [unduh zip](https://github.com/nulis-not-just-writing/skills/raw/main/dist/slr-cowork-1.5.0.zip)
...
### 1. Anda mau menulis tinjauan sistematis dan belum tahu mulai dari mana

> *"Saya mau bikin systematic review tentang pembelajaran berbasis proyek di vokasi."*

Tahap 1 menghasilkan **form kesepakatan kerja** — rujukan tunggal untuk seluruh proyek: pertanyaan,
kriteria inklusi-eksklusi beserta legendanya, basis data, dan siapa menilai apa. Semua tahap
berikutnya membaca form itu, sehingga keputusan tidak bergeser diam-diam di tengah jalan.

Tahap 2 punya gerbang yang menahan Anda sebelum jauh: **apakah pertanyaan itu memang dapat dijawab
sebuah SLR?** Bila judul Anda menuntut klaim normatif orde pertama — *"merumuskan model ideal"* —
sementara SLR hanya sanggup menghasilkan pemetaan orde kedua, ketidaksepadanan itu tidak akan
ketahuan sampai manuskrip ditulis.

### 2. Angka Anda tidak rekonsiliasi

Diagram alir PRISMA menuntut aritmetika yang konsisten dari identifikasi sampai inklusi. Angka
di abstrak, di teks, dan di figur harus sama.

Skill ini membekukan korpus, merekonsiliasi himpunan ID antar tahap, dan mengaudit kaskadenya.
Ketidaksesuaian dilaporkan sebagai konflik untuk Anda putuskan — bukan ditambal agar terlihat
rapi.

### 3. Korpus Anda doktrinal-normatif dan instrumen standar terasa tidak pas

Hukum, fikih, filsafat. Sebagian besar instrumen SLR lahir dari epidemiologi klinis dan
**tidak punya objek** di sana — tidak ada populasi, tidak ada intervensi, tidak ada ukuran hasil.

Yang tidak berlaku adalah **instrumennya**, bukan tahapnya. Tersedia kerangka pengganti PICO,
aturan status sumber primer (fatwa, regulasi, putusan **tidak masuk hitungan PRISMA**), dan rubrik
appraisal berbasis kualitas argumentasi.

### 4. Anda peneliti tunggal dan butuh penyaring kedua

Form kesepakatan menyediakan **opsi (d)**: perkakas AI sebagai pass kedua. Sah, dan didukung
pernyataan sikap bersama Cochrane, Campbell, JBI, dan CEE — dengan tiga syarat: terdokumentasi,
tiap baris dikonfirmasi manusia, dan **dinamai dengan benar**.
